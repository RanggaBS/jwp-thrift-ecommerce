...
function isHomePage()
{
  ...
  // Cek jika path kosong atau hanya mengarah ke index.php
...
<nav class="fixed bottom-0 z-[2] w-full border-t sm:hidden border-zinc-300 bg-zinc-50">
  <div class="section-wrapper">
    <ul class="flex items-center w-full" style="justify-content: space-around">
      <li>
        <a href="../" class="mobile-nav-icon">
          ...
          <?php } else { ?>
            ...
            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M15 18H9" stroke="#000000" stroke-width="1.5" stroke-linecap="round" />
            </svg>

          <?php } ?>

          <span class="text-xs sr-only">Home</span>
        </a>
      </li>
      <li>
        <a href="../cart.php" class="mobile-nav-icon">

          <?php if (Util::str_contains($_SERVER["SCRIPT_NAME"], "cart")) { ?>
      ...
      <li>
        <a href="../account/" class="mobile-nav-icon">

          <?php if (Util::str_contains($_SERVER["SCRIPT_NAME"], "account")) { ?>
...
<?php
// echo "<div class='fixed grid top-1/2 left-1/2 place-items-center'>";
// echo "<h1>";
